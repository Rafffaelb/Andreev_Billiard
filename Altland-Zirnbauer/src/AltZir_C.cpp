...
void AltZir_C::Save_txt_files_Gamma(MatrixXcd G, MatrixXcd P, int num_steps, int N1){

	std::ofstream output_G("Data_Analysis/Gamma/Andreev_G_C_Gamma_N"+to_string(N1)+".txt");
	std::ofstream output_P("Data_Analysis/Gamma/Andreev_P_C_Gamma_N"+to_string(N1)+".txt");
...
void AltZir_C::Save_txt_files_Bell_Parameter_Gamma(MatrixXd Bell_Parameter_Gamma, MatrixXd Bell_Parameter_Dephase_Gamma, int num_steps){

	std::ofstream output_Bell_Parameter_Gamma("Data_Analysis/Bell_Parameter/Bell_Gamma/Andreev_Bell_Parameter_C_Gamma.txt");
	std::ofstream output_Bell_Parameter_Dephase_Gamma("Data_Analysis/Bell_Parameter/Bell_Gamma/Andreev_Bell_Parameter_Dephase_C_Gamma.txt");
...
void AltZir_C::Save_txt_files_Bell_Parameter_Fixed_Base(MatrixXd Bell_Parameter_Fixed_Base, int num_steps){

	std::ofstream output_Bell_Parameter_Fixed_Base("Data_Analysis/Bell_Parameter/Bell_Fixed_Base/Andreev_Bell_Parameter_C_Fixed_Base.txt");
